...
function CreateTask() {
    ...
    const submitHandler = (e) => {
        ...
        setNewTask({taskTitle, taskDate, category, taskDescription, newTask:true, active:false, completed:false, failed:false})
  ...
  <div className='p-5 bg-[#1c1c1c] mt-5 rounded'>
      <form onSubmit={(e)=>{submitHandler(e)}} className='w-full flex flex-wrap items-start justify-between '>
          <div className='w-1/2'>
              <div>
              ...
              <div>
                  <h3 className='text-sm text-gray-300 mb-0.5'>Asssign to</h3>
          ...
          <div className='w-2/5 flex flex-col items-start'>
              ...
              <textarea value={taskDescription} onChange={(e)=>{setTaskDescription(e.target.value)}} className='w-full h-44 py-2 px-4 rounded outline-none bg-transparent border-[1px] border-gray-400' rows={6}></textarea>
              <button className='bg-emerald-500 py-3 cursor-pointer hover:bg-emerald-600 rounded text-lg mt-4 w-full'>Create Task</button>
          </div>
      </form>
  </div>
  )
